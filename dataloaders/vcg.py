...
def vcg_record_to_tokens(tokenizer: VisualCometTokenizer,
    ...
    inference_text = record['inference_text_name'] ### diff
...
def _create_partial_labels(tokenizer: VisualCometTokenizer, tokenized_text, mode): ### diff
    try:
...
class VCGDataset:
    def __init__(self,
        ...
        splits = ['train', 'val']
        #splits = ['train'] #should be removed
