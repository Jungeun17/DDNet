...
class GPT2VisionAttentiveLMHeadPlc(GPT2PreTrainedModel):
    def __init__(self, config):
        super(GPT2VisionAttentiveLMHeadPlc, self).__init__(config)
    ...
    def forward(self,
        ...
        lm_logit = self.lm_head(transformer_outputs[0])
